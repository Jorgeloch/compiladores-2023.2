...
public final class AFatorExprMatematica extends PExprMatematica
{
    private PFator _fator_;

    public AFatorExprMatematica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFatorExprMatematica(
    ...
    {
        ((Analysis) sw).caseAFatorExprMatematica(this);
    }
