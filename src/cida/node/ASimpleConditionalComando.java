...
public final class ASimpleConditionalComando extends PComando
{
    private TIn _in_;
    ...
    public ASimpleConditionalComando()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASimpleConditionalComando(
            cloneNode(this._in_),
    ...
    {
        ((Analysis) sw).caseASimpleConditionalComando(this);
    }
