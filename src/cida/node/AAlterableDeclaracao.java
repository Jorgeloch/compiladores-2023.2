...
public final class AAlterableDeclaracao extends PDeclaracao
{
    ...
    public Object clone()
    {
        return new AAlterableDeclaracao(
    ...
    {
        ((Analysis) sw).caseAAlterableDeclaracao(this);
    }
