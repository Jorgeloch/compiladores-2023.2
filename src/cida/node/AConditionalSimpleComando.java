...
public final class AConditionalSimpleComando extends PComando
{
    private TIn _in_;
    ...
    public AConditionalSimpleComando()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AConditionalSimpleComando(
            cloneNode(this._in_),
    ...
    {
        ((Analysis) sw).caseAConditionalSimpleComando(this);
    }
